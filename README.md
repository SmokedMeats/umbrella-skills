...
| Two+ unblocked implement tickets | `/implement` **wave**: spawn children, then crawl later waves as they unlock | same |
...
| Skill | Change |
| --- | --- |
| `umbrella` | New conductor. Two+ unblocked tickets → `/implement` wave; crawl later waves as they unlock. |
